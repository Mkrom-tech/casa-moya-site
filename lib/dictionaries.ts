...
export const dictionaries = {
  nl: {
    ...
    property: {
      ...
      calendarError: "Kon de kalender nu niet laden. Probeer het later opnieuw.",
    ...
    register: {
      ...
      signatureHint: "Teken met je muis of vinger",
      signatureClear: "Wis handtekening",
      signatureRequired: "Zet een handtekening voordat je verstuurt.",
    ...
    homeExtra: {
      ...
      guidesTitle: "Op zoek naar het juiste vakantiehuis?",
  ...
  en: {
    ...
    property: {
      ...
      bathrooms: "bathrooms",
      perNight: "per night",
      avgPriceNote: "(average)",
      amenitiesTitle: "Amenities",
      galleryTitle: "Photos",
      reviewsTitle: "What guests say",
      reviewsSource: "Reviewed on",
      ...
      calendarError: "Couldn't load the calendar right now. Please try again later.",
      available: "Available",
      booked: "Booked"
    },
    form: {
    ...
    register: {
      ...
      signatureHint: "Draw with your mouse or finger",
    ...
    homeExtra: {
      ...
      guidesTitle: "Looking for the right vacation home?",
  ...
  es: {
    ...
    property: {
      ...
      bathrooms: "baños",
      perNight: "por noche",
      avgPriceNote: "(promedio)",
      amenitiesTitle: "Servicios",
      galleryTitle: "Fotos",
      reviewsTitle: "Lo que dicen los huéspedes",
      reviewsSource: "Reseña en",
      availabilityTitle: "Disponibilidad",
      inquiryTitle: "Solicitud de reserva",
      backToOverview: "Volver al resumen",
      loadingAvailability: "Cargando disponibilidad…",
      notConnected:
        "Conecta aquí los calendarios de Airbnb y Booking.com (iCal) para que los huéspedes siempre vean la disponibilidad real y sea imposible reservar en fechas duplicadas.",
      calendarError: "No se pudo cargar el calendario. Inténtalo de nuevo más tarde.",
    ...
    form: {
      ...
      success:
        "¡Gracias! Tu solicitud ha sido enviada. Nos pondremos en contacto contigo en un plazo de 24 horas.",
    ...
    register: {
      ...
      signatureHint: "Dibuja con el ratón o el dedo",
      signatureClear: "Borrar firma",
      signatureRequired: "Firma antes de enviar.",
    ...
    homeExtra: {
      ...
      guidesTitle: "¿Buscas la casa de vacaciones ideal?",
  ...
  it: {
    ...
    property: {
      ...
      reviewsSource: "Recensione su",
      availabilityTitle: "Disponibilità",
      inquiryTitle: "Richiesta di prenotazione",
      backToOverview: "Torna alla panoramica",
      loadingAvailability: "Caricamento disponibilità…",
      notConnected:
        "Collega qui i calendari di Airbnb e Booking.com (iCal) in modo che gli ospiti vedano sempre la disponibilità reale e le prenotazioni doppie siano impossibili.",
      calendarError: "Impossibile caricare il calendario. Riprova più tardi.",
    ...
    form: {
      ...
      success:
        "Grazie! La tua richiesta è stata inviata. Ti risponderemo entro 24 ore.",
    ...
    register: {
      ...
      signatureLabel: "Firma",
      signatureHint: "Disegna con il mouse o il dito",
    ...
    homeExtra: {
      ...
      guidesTitle: "Cerchi la casa vacanze giusta?",
  ...
  de: {
    ...
    property: {
      ...
      perNight: "pro Nacht",
      avgPriceNote: "(durchschnittlich)",
      amenitiesTitle: "Ausstattung",
      galleryTitle: "Fotos",
      reviewsTitle: "Was Gäste sagen",
      reviewsSource: "Bewertet auf",
    ...
    register: {
      ...
      signatureHint: "Mit Maus oder Finger zeichnen",
      signatureClear: "Unterschrift löschen",
      signatureRequired: "Bitte unterschreiben Sie vor dem Absenden.",
    ...
    homeExtra: {
      ...
      guidesTitle: "Auf der Suche nach dem richtigen Ferienhaus?",
